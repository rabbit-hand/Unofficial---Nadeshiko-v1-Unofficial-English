# 🚀 Unofficial Nadeshiko v1 — Frictionless English Edition

An unofficial English branch of the Japanese natural-language programming language **"Nadeshiko" (v1)**. This project has been heavily modified and refactored to remove all unnecessary input friction, dropping rigid syntax requirements for a smoother coding experience.

---

## ✨ Key Features (Frictionless Syntax)

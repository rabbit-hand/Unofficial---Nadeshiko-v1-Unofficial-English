...
//------------------------------------------------------------------------------
  ...
  token_koko      = 99211;
  // English control structure tokens
  token_if        = 99212;
  token_then      = 99213;
  token_else      = 99214;
  token_while     = 99215;
  ...
  token_end       = 99217;
  token_break     = 99218;
  token_continue  = 99219;
  token_return    = 99220;
  token_exit      = 99221;
  token_function  = 99222;
  token_var       = 99223;
  token_string    = 99224;
  token_number    = 99225;
  token_integer   = 99226;
...
begin
  ...
  begin
    ...
    // English control structure tokens
    SetID('IF', token_if);
    SetID('THEN', token_then);
    SetID('ELSE', token_else);
    SetID('WHILE', token_while);
    SetID('FOR', token_for);
    SetID('END', token_end);
    SetID('BREAK', token_break);
    SetID('CONTINUE', token_continue);
    SetID('RETURN', token_return);
    SetID('EXIT', token_exit);
    SetID('FUNCTION', token_function);
    SetID('VAR', token_var);
    SetID('STRING', token_string);
    SetID('NUMBER', token_number);
    SetID('INTEGER', token_integer);
    SetID('FLOAT', token_float);
    SetID('ARRAY', token_array);
    SetID('HASH', token_hash);
    SetID('GROUP', token_group);
...
begin
  ...
  begin
    ...
    // English particles for English Nadesiko
    SetID('to', josi_to);
    SetID('from', josi_from);
    SetID('by', josi_by);
    SetID('with', josi_with);
    SetID('and', josi_and);
    SetID('or', josi_or);
    SetID('is', josi_is);
    SetID('are', josi_are);
    ...
    SetID('for', josi_for);
    SetID('as', josi_as);
    SetID('then', josi_then);
    SetID('else', josi_else);
    SetID('plus', josi_plus);
    SetID('minus', josi_minus);
    SetID('times', josi_times);
    //</助詞の登録>
